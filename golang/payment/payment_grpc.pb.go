...
type PaymentClient interface {
	Create(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CretePaymentResponse, error)
}
...
func (c *paymentClient) Create(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CretePaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CretePaymentResponse)
...
type PaymentServer interface {
	Create(context.Context, *CreatePaymentRequest) (*CretePaymentResponse, error)
...
func (UnimplementedPaymentServer) Create(context.Context, *CreatePaymentRequest) (*CretePaymentResponse, error) {
