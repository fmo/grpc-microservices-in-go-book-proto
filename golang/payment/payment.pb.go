...
type CretePaymentResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CretePaymentResponse) Reset() {
	*x = CretePaymentResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CretePaymentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CretePaymentResponse) ProtoMessage() {}

func (x *CretePaymentResponse) ProtoReflect() protoreflect.Message {
	mi := &file_payment_payment_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CretePaymentResponse.ProtoReflect.Descriptor instead.
func (*CretePaymentResponse) Descriptor() ([]byte, []int) {
	return file_payment_payment_proto_rawDescGZIP(), []int{1}
}

func (x *CretePaymentResponse) GetPaymentId() int64 {
	if x != nil {
		return x.PaymentId
	}
	return 0
...
func (x *CretePaymentResponse) GetBillId() int64 {
	if x != nil {
		return x.BillId
	}
	return 0
...
var file_payment_payment_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x63, 0x65, 0x22, 0x4e, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x74, 0x65, 0x50, 0x61, 0x79,
	...
	,
...
var file_payment_payment_proto_goTypes = []interface{}{
	...
	(*CretePaymentResponse)(nil), // 1: CretePaymentResponse
}
var file_payment_payment_proto_depIdxs = []int32{
	0, // 0: Payment.Create:input_type -> CreatePaymentRequest
	1, // 1: Payment.Create:output_type -> CretePaymentResponse
...
func file_payment_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_payment_payment_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CretePaymentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
